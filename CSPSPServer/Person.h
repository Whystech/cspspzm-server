...
public:
	...
	static int mArmorDamageReduction;
	static int mCTMaxHealth;
	static int mTMaxHealth;
	static int mCTMaxArmor;
	static int mTMaxArmor;
	static int mCTSpawnHealth;
	static int mTSpawnHealth;
	static int mCTSpawnArmor;
	static int mTSpawnArmor;
	static int mStartingMoney;
	static float mPickupRadius;
	static float mDamageSpeedMultiplier;
	static float mAcceleration;
	static float mDeceleration;
